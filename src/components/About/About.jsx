      ...
      <div className="container">
        <div className="flex justify-between flex-col  lg:flex-row gap-[50px] lg:gap-[130px] xl:gap-0 ">
          ...
          <div className=" w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            <h2 className="heading">Proud to be one of the best in the nation.t</h2>
            <p className="text__para">
              For 20 years in a row, W.H.O & World Report has recognized us as one of the best public Hospital in the Nation and #1 in Mumbai.
